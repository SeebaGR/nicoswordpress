...
class ChilexpressController extends Controller
{
    ...
    private $apicoberturas = 'dad6ae9cb40d47d9966bb2cb86e0e6d8';
    ...
    public function getDestinations($regionCode)
    {
            ...
            $response = $this->getClient()->withHeaders([
                'Ocp-Apim-Subscription-Key' => $this->apicoberturas,
                'Content-Type' => 'application/json'
            ])->get("{$this->baseUrl}/georeference/api/v1.0/coverage-areas", [
                'query' => [
            ...
            return response()->json(['error' => 'No se pudieron cargar los destinos.'], $response->getStatusCode());
